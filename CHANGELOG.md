...
- **Animated curved text.** Fixed-range baselines invalidate visual geometry without rerunning intrinsic layout, stale path revisions replace their cache entries, curve measurement retains a stable minimum subdivision topology across morph frames, tangents interpolate continuously, and MIRX font metrics avoid repeated representation selection.
