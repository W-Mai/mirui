...
- **Typography Lab.** A responsive Gallery surface renders Latin ligatures and kerning, CJK metrics, Arabic joining and marks, Thai mark placement, mixed-direction fallback, and the coverage-to-SDF size ladder from borrowed MIRX font assets. Signal-backed controls change ppem, width, wrapping, alignment and overflow through the shared paragraph layout.
