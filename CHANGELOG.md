...
- **Scene group bounds.** Nested affine transforms now contribute to filter extents and sibling-overlap checks. Projective groups and unresolved glyph ink bounds report explicit errors where exact bounds are required instead of being treated as zero-size or disjoint.
