...
- **Shared atlas maps.** `image::AtlasMap` provides checked native and wire rectangle views for FONT and other atlas-backed payloads without allocation or domain-specific metadata.
