...
- **Text on paths.** Retained path bindings place shaped glyphs and carets along measured baselines, preserve caller-owned bounded frame storage, expose transformed caret hit testing and selection ribbons, and render posed glyph runs across software, SDL GPU, WGPU, and Web Canvas backends.
