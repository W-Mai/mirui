...
- **Inspectable themes.** `ThemeInfo`, `ThemeId`, `ThemeCatalog`, `App::theme`, and the theme editing APIs expose borrowed theme identity, ID-based selection, and safe token mutation with one root invalidation.
