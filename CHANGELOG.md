...
- **SDL GPU rounded images.** Rounded axis-aligned image blits use the configured bounded fallback, preserving opacity and composite mode without changing ordinary image uploads.
