...
- **Pluggable frame-residual execution.** Validated FrameDelta blocks dispatch through a public allocation-free kernel seam. AArch64 selects NEON and x86-64 selects SSE2 for literal, repeated and compatible patterned residuals; scalar tails and explicit scalar execution preserve bit-exact modulo-256 reconstruction.
