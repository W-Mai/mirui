...
//! ```toml
//! [dependencies]
//! mirui = { version = "0.38", features = ["sdl"] }
//! ```
//!
...
pub use mirui_macros::{Component, mold, path, scene, system, trace_fn, trace_span, ui};
...
pub mod prelude {
    ...
    pub use mirui_macros::{animate, mold, path, scene, system, timer, trace_fn, trace_span, ui};
