...
impl Canvas for Dummy {
    fn fill_path(&mut self, _: &Path, _: &Rect, _: &Color, _: u8, _: ::mirui::render::raster::FillRule) {}
    fn stroke_path(&mut self, _: &Path, _: &Rect, _: Fixed, _: &Color, _: u8, _: ::mirui::render::raster::LineCap, _: ::mirui::render::raster::LineJoin, _: ::mirui::types::Fixed) {}
